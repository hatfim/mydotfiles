...
sudo scutil --set ComputerName "0x68617466696d"

echo "  › Set host name"
sudo scutil --set HostName "0x68617466696d"

echo "  › Set local host name"
sudo scutil --set LocalHostName "0x68617466696d"

echo "  › Set net bios name"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "0x68617466696d"
